...
Public Class welcome
    ...
    Private Sub QuestionsAnswersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QuestionsAnswersToolStripMenuItem.Click
        questionsAnswersForm.ShowDialog()
    End Sub
End Class
